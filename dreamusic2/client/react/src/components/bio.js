...
function Bio(){
    return(
        <div className="bg-image container-fluid mb-5 align-content-center" style={{backgroundImage: `url(${image}`, height:"400px", backgroundSize:"cover", backgroundRepeat:"no-repeat"}}>          
